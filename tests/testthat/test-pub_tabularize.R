...
test_that("pub_tabularize fails well", {
  ...
  expect_error(pub_tabularize('adfafsdf'), "x must be of class pub_chunks")
  expect_error(pub_tabularize(5), "x must be of class pub_chunks")
})
